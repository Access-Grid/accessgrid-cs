...
namespace AccessGrid
{
    ...
    public class AccessCard
    {
        ...
        /// <summary>
        /// System identifier used in key diversification, only allowed if your card template has key diversification enabled. Must be an even number of hex characters; the server does not check this and uses any other value as raw text. Generated by the server when unset. Returned only by IssueAsync and ProvisionAsync, and only for templates with key diversification; it is null on cards from GetAsync, ListAsync and UpdateAsync, so store it when you issue. Can not be combined with SkipSystemId
        /// </summary>
    ...
    public class ProvisionCardRequest : AccessCard
    {
        ...
        /// <summary>
        /// Set to true to leave the system identifier out of key diversification. Can not be combined with SystemId
        /// </summary>
        [JsonPropertyName("skip_system_id")]
        public bool? SkipSystemId { get; set; }
    }
